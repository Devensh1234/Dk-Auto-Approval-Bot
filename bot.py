...
async def approve(_, m : Message):
    ...
    try:
        ...
        await app.send_video(kk.id,img, "**Hello {}!\nWelcome To {}\n\n__Powerd By : @DKANIME47 __**".format(m.from_user.mention, m.chat.title))
        add_user(kk.id)
    ...
    try:
        ...
        if m.chat.type == enums.ChatType.PRIVATE:
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("🗯 Channel", url="https://t.me/DKANIME47"),
                        InlineKeyboardButton("💬 Support", url="https://t.me/dk_anime_group")
                    ],[
                        InlineKeyboardButton("➕ Add me to your Chat ➕", url="https://t.me/auto_request_approve_dk_bot?startgroup")
                    ]
                ]
            )
            add_user(m.from_user.id)
            await m.reply_photo("https://graph.org/file/d57d6f83abb6b8d0efb02.jpg", caption="**🦊 Hello {}!\nI'm an auto approve [Admin Join Requests]({}) Bot.\nI can approve users in Groups/Channels.Add me to your chat and promote me to admin with add members permission.\n\n__Powerd By : @dkanime47 __**".format(m.from_user.mention, "https://t.me/telegram/153"), reply_markup=keyboard)
    
        elif m.chat.type == enums.ChatType.GROUP or enums.ChatType.SUPERGROUP:
            keyboar = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("💁‍♂️ Start me private 💁‍♂️", url="https://t.me/auto_request_approve_dk_bot?startgroup")
                    ]
                ]
            )
            add_group(m.chat.id)
